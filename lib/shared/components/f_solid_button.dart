...
import 'package:our_bung_play/shared/custom/f_bounceable.dart';
...
import 'package:our_bung_play/shared/themes/f_font_weight.dart';
...
class _FSolidButtonState extends State<FSolidButton> {
  ...
  Color _bgColor() {
    ...
    switch (widget.variant) {
      case FSolidButtonVariant.primary:
        return FColors.of(context).sky40;
  ...
  Widget build(BuildContext context) {
    return FBounceable(
      ...
      child: Container(
        decoration: BoxDecoration(color: _bgColor(), borderRadius: BorderRadius.circular(widget.borderRadius ?? 8)),
