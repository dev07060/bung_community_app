  ...
  Widget _buildLabel() {
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            Text(widget.label!, style: FTextStyles.body2_14Rd.b.copyWith(color: FColors.of(context).labelNormal)),
              ...
              Column(
                children: [
                  Text(
                    ...
                    style: FTextStyles.body2_14Rd.b.copyWith(color: FColors.of(context).statusNegative),
                  ),
