...
class SPColors {
  ...
  static Color getExerciseColor(String categoryName) {
    switch (categoryName.toLowerCase()) {
      ...
      case '등산':
      case '하이킹':
        return const Color(0xFF795548); // Brown for hiking
      case '테니스':
      case '배드민턴':
        return const Color(0xFF607D8B); // Blue Grey for racket sports
      default:
  ...
  static Color getDietColor(String categoryName) {
    switch (categoryName.toLowerCase()) {
      ...
      case '간식':
      case '디저트':
        return const Color(0xFFFF7043); // Deep Orange for snacks
      case '음료':
      case '차':
      case '커피':
        return const Color(0xFF8D6E63); // Brown for beverages
      default:
  ...
  static LinearGradient get motivationGradient => const LinearGradient(
      colors: [motivationRed, motivationOrange], begin: Alignment.topLeft, end: Alignment.bottomRight);

  // Success gradient for achievements
  static LinearGradient get successGradient => const LinearGradient(
      colors: [motivationGreen, reportGreen], begin: Alignment.topLeft, end: Alignment.bottomRight);
